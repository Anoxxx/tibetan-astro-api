...
from tibetan_astro_tables import (
    ANIMAL_SIGNS_MOD_12_MAP, TIANGAN_MAP_MOD_10, SIXTY_CYCLE_NAMES,
    LIFE_MEWA_ROTATION, BODY_MEWA_ROTATION, POWER_MEWA_ROTATION,
    MEWA_COLORS, MEWA_ELEMENTS, DARKNESS_BODY_MEWA, ELEMENT_CLASH_MAP,
    OBSTACLE_INTERPRETATIONS, PROSPERITY_EVENT_TYPES, HOUR_ANIMAL_MAP,
    ANIMAL_ELEMENT_MAP, ELEMENT_GENERATE_MAP
)
